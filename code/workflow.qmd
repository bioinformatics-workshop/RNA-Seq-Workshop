...
We will obtain a SRA sample list containing information for a BioProject stored in the SRA database. Input for the list is the BioProject ID: PRNAxxxxxxxx
...
Data were dobwloaded from the NCBI SRA server to the HPCC cluster
